...
public class SignUpUI {
    ...
    public static JDialog UserSignUpDial;
    ...
    public SignUpUI() throws SQLException, IOException {
        Usermngt = new DBConUserMngt();
        Inv = new InputVerification();

        //Create JDialog UserSignUpDia
        UserSignUpDial = new JDialog();

        try {
            UserSignUpDial.setIconImage(ImageIO.read(new File("C:\\Users\\EliteBook 8460p\\Documents\\NetBeansProjects\\Academic "
                    + "Informer\\src\\Resources\\Images\\Register-icon.png")));
        } catch (IOException ex) {
            Logger.getLogger(UserRegistration.class.getName()).log(Level.SEVERE, null, ex);
        }
        UserSignUpDial.setModalityType(Dialog.ModalityType.APPLICATION_MODAL);
        ...
        Usermngt.UserNamelbl.setBounds(30, 105, 120, 30);
        ...
        Usermngt.RegEmplbl.setBounds(30, 60, 120, 30);
        ...
        Usermngt.Passwordlbl.setBounds(30, 155, 120, 30);
        ...
        Usermngt.Passwordconflbl.setBounds(30, 205, 120, 30);
        ...
        Usermngt.UserNametxt.setBounds(155, 105, 220, 30);

        PasswordField = new JPasswordField(12);
        PasswordField.setEchoChar('*');
        PasswordField.setBounds(155, 155, 220, 30);

        PasswordConfField = new JPasswordField(12);
        PasswordConfField.setEchoChar('*');
        PasswordConfField.setBounds(155, 205, 220, 30);
        ...
        RegNocmb.setBounds(155, 60, 220, 30);
        ...
        Usermngt.Savebtn.setBounds(155, 270, 70, 30);
        ...
        UserSignUpDial.add(UserSignUpPanel);
        UserSignUpDial.setSize(470, 370);
        UserSignUpDial.setLocationRelativeTo(null);
        UserSignUpDial.setTitle(" SignUp");
        UserSignUpDial.setVisible(true);

    }

    public static void main(String[] args) throws SQLException, IOException {
        SignUpUI ur = new SignUpUI();
